...
public class CadastroCasa {
    ...
    public CadastroCasa(DadosImoveis im) {
        ...
        lNumPiscinas = new JLabel("Num. Piscinas: ");
        lNumPiscinas.setBounds(260,200,120,25);
        tfNumPiscinas = new JTextField(20);
        tfNumPiscinas.setBounds(380,200,80,25);
        panel.add(lNumPiscinas);
        panel.add(tfNumPiscinas);
