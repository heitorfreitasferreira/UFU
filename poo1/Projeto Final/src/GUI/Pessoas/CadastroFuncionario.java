...
public class CadastroFuncionario{
    ...
    private static JTextField tfCpf,tfNome,tfCelular, tfTelFixo,tfEmail, tfRua, tfComplemento, tfCep, tfCidade, tfBairro, tfNro,tfCargo,tfEstadoCivil,tfUsuario;
    private static JCheckBox cbMulher;
    private static JButton btnSubmit,btnMenu;
    private static JLabel lCpf,lNome,lCelular,lTelFixo,lEmail,lRua,lComplemento,lCep,lCidade,lMulher,lBairro,lNro,lCargo,lEstadoCivil,lUsuario,lSenha;
    private static JPasswordField pfSenha;
    private static JRadioButton rbHomem, rbMulher;
    private static JComboBox cbEstadoCivil;
    public CadastroFuncionario(DadosFuncionarios funcionarios){
        JFrame frame = new JFrame();
        panel = new JPanel();
        panel.setLayout(null);
        frame.setTitle("Cadastro Funcionario");
...
//        panel.add(lMulher);
        ...
        btnSubmit.setBounds(180,540,150,30);
        panel.add(btnSubmit);
