...
uma lista de booleanos e o fenótipo é a soma dos valores verdadeiros do genótipo. 
O fitness é representado pela maximização do fenótipo.
...
def gera_filhos(
    ...
    for _ in range(quantidade_filhos):
        ...
        pai_index = np.random.choice(range(len(pais)))
        mae_index = np.random.choice(range(len(pais)))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cromossomo_size", type=int,
                        default=8, help="Tamanho do cromossomo")
