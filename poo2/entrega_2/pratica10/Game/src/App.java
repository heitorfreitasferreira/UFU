...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        var labirinto = new SalaEscolha(new SalaEscolha(new Saida(), new Abismo(),geradorInimigos.create(0.9, "Rivalino")), new SalaEscolha(new Abismo(), new Saida(), geradorInimigos.create(0.9, "Rivalino")), geradorInimigos.create(0.9, "Cálculo 2"));
        for (Personagem jogador : jogadores) {
        labirinto.selecionarCaminho(jogador);
        }
