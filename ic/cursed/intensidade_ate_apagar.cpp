...
#pragma region salvaDados
        ...
        escreve_dados_analise_individual(dadosHeitorzera1[k], "heitorzera1_coef1_ate_parar.csv");
...
#pragma region salvaDados
        dadosHeitorzera1[k].iteracoes_ate_apagar = iteracao;
        escreve_dados_analise_individual(dadosHeitorzera1[k], "heitorzera1_coef0,5_ate_parar.csv");
#pragma endregion salvaDados
    }
#pragma region salvaDadosArquivo
    cout << "Heitorzeira1" << endl;
...
#pragma region salvaDados
        dadosHeitorzera1[k].iteracoes_ate_apagar = iteracao;
        escreve_dados_analise_individual(dadosHeitorzera1[k], "heitorzera1_coef1,5_ate_parar.csv");
#pragma endregion salvaDados
    }
#pragma region salvaDadosArquivo
    cout << "Heitorzeira1" << endl;
